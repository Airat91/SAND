...
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[29],	(void*)&sofi_prop_base_list[35]},	2,       	(u8*)&test.vars.arr_u8,          	"arr_u8",       	"None",                         	VAR_TYPE_U8,    	20,       	35, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[36],	(void*)&sofi_prop_base_list[36]},	2,       	(u8*)&test.vars.arr_u16,         	"arr_u16",      	"None",                         	VAR_TYPE_U16,   	20,       	36, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[37],	(void*)&sofi_prop_base_list[37]},	2,       	(u8*)&test.vars.arr_u32,         	"arr_u32",      	"None",                         	VAR_TYPE_U32,   	20,       	37, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[38],	(void*)&sofi_prop_base_list[38]},	2,       	(u8*)&test.vars.arr_u64,         	"arr_u64",      	"None",                         	VAR_TYPE_U64,   	20,       	38, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[39],	(void*)&sofi_prop_base_list[39]},	2,       	(u8*)&test.vars.arr_s8,          	"arr_s8",       	"None",                         	VAR_TYPE_S8,    	20,       	39, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[40],	(void*)&sofi_prop_base_list[40]},	2,       	(u8*)&test.vars.arr_s16,         	"arr_s16",      	"None",                         	VAR_TYPE_S16,   	20,       	40, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[41],	(void*)&sofi_prop_base_list[41]},	2,       	(u8*)&test.vars.arr_s32,         	"arr_s32",      	"None",                         	VAR_TYPE_S32,   	20,       	41, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[42],	(void*)&sofi_prop_base_list[42]},	2,       	(u8*)&test.vars.arr_s64,         	"arr_s64",      	"None",                         	VAR_TYPE_S64,   	20,       	42, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[43],	(void*)&sofi_prop_base_list[43]},	2,       	(u8*)&test.vars.arr_float,       	"arr_float",    	"None",                         	VAR_TYPE_FLOAT, 	20,       	43, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[44],	(void*)&sofi_prop_base_list[44]},	2,       	(u8*)&test.vars.arr_double,      	"arr_double",   	"None",                         	VAR_TYPE_DOUBLE,	20,       	44, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[45],	(void*)&sofi_prop_base_list[45]},	2,       	(u8*)&test.vars.arr_char,        	"arr_char",     	"None",                         	VAR_TYPE_CHAR,  	20,       	45, 	0},
};
...
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[35]},	110},
...
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[36]},	149},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[37]},	169},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[38]},	209},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[39]},	289},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[40]},	299},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[41]},	319},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[42]},	359},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[43]},	439},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[44]},	479},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[45]},	559},
};
