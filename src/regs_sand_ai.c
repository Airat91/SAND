...
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[10],	(void*)&sofi_prop_base_list[10]},	2,       	(u8*)&time.vars.year,                  	"year",                	"None",                 	VAR_TYPE_U16,  	1,        	10, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[11],	(void*)&sofi_prop_base_list[11]},	2,       	(u8*)&time.vars.month,                 	"month",               	"None",                 	VAR_TYPE_U8,   	1,        	11, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[12],	(void*)&sofi_prop_base_list[12]},	2,       	(u8*)&time.vars.day,                   	"day",                 	"None",                 	VAR_TYPE_U8,   	1,        	12, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[13],	(void*)&sofi_prop_base_list[13]},	2,       	(u8*)&time.vars.hour,                  	"hour",                	"None",                 	VAR_TYPE_U8,   	1,        	13, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[14],	(void*)&sofi_prop_base_list[14]},	2,       	(u8*)&time.vars.minute,                	"minute",              	"None",                 	VAR_TYPE_U8,   	1,        	14, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[15],	(void*)&sofi_prop_base_list[15]},	2,       	(u8*)&time.vars.sec,                   	"sec",                 	"None",                 	VAR_TYPE_U8,   	1,        	15, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[16],	(void*)&sofi_prop_base_list[16]},	2,       	(u8*)&time.vars.msec,                  	"msec",                	"None",                 	VAR_TYPE_U8,   	1,        	16, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[17],	(void*)&sofi_prop_base_list[17]},	2,       	(u8*)&time.vars.unix,                  	"unix",                	"None",                 	VAR_TYPE_U32,  	1,        	17, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[18],	(void*)&sofi_prop_base_list[18]},	2,       	(u8*)&time.vars.utc,                   	"utc",                 	"None",                 	VAR_TYPE_S8,   	1,        	18, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[19],	(void*)&sofi_prop_base_list[19]},	2,       	(u8*)&device.vars.device_type,         	"device_type",         	"None",                 	VAR_TYPE_U8,   	1,        	19, 	1},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[20],	(void*)&sofi_prop_base_list[20]},	4,       	(u8*)&device.vars.device_name,         	"device_name",         	"None",                 	VAR_TYPE_CHAR, 	40,       	20, 	1},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[21],	(void*)&sofi_prop_base_list[21]},	2,       	(u8*)&device.vars.board_ver,           	"board_ver",           	"None",                 	VAR_TYPE_U8,   	1,        	21, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[22],	(void*)&sofi_prop_base_list[22]},	3,       	(u8*)&device.vars.serial_very_long_nam,	"serial_very_long_nam",	"None",                 	VAR_TYPE_U32,  	1,        	22, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[23],	(void*)&sofi_prop_base_list[23]},	3,       	(u8*)&device.vars.configuration,       	"configuration",       	"None",                 	VAR_TYPE_CHAR, 	40,       	23, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[24],	(void*)&sofi_prop_base_list[24]},	2,       	(u8*)&device.vars.temperature,         	"temperature",         	"None",                 	VAR_TYPE_FLOAT,	1,        	24, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[25],	(void*)&sofi_prop_base_list[25]},	2,       	(u8*)&device.vars.v_bat,               	"v_bat",               	"None",                 	VAR_TYPE_FLOAT,	1,        	25, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[26],	(void*)&sofi_prop_base_list[26]},	2,       	(u8*)&device.vars.v_pwr,               	"v_pwr",               	"None",                 	VAR_TYPE_FLOAT,	1,        	26, 	0},
