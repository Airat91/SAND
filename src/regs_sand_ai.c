...
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[32],	(void*)&sofi_prop_base_list[32]},	2,       	(u8*)&test.vars.arr_u8,         	"arr_u8",       	"None",                         	VAR_TYPE_U8,    	20,       	32, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[33],	(void*)&sofi_prop_base_list[33]},	2,       	(u8*)&test.vars.arr_u16,        	"arr_u16",      	"None",                         	VAR_TYPE_U16,   	20,       	33, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[34],	(void*)&sofi_prop_base_list[34]},	2,       	(u8*)&test.vars.arr_u32,        	"arr_u32",      	"None",                         	VAR_TYPE_U32,   	20,       	34, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[35],	(void*)&sofi_prop_base_list[35]},	2,       	(u8*)&test.vars.arr_u64,        	"arr_u64",      	"None",                         	VAR_TYPE_U64,   	20,       	35, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[36],	(void*)&sofi_prop_base_list[36]},	2,       	(u8*)&test.vars.arr_s8,         	"arr_s8",       	"None",                         	VAR_TYPE_S8,    	20,       	36, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[37],	(void*)&sofi_prop_base_list[37]},	2,       	(u8*)&test.vars.arr_s16,        	"arr_s16",      	"None",                         	VAR_TYPE_S16,   	20,       	37, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[38],	(void*)&sofi_prop_base_list[38]},	2,       	(u8*)&test.vars.arr_s32,        	"arr_s32",      	"None",                         	VAR_TYPE_S32,   	20,       	38, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[39],	(void*)&sofi_prop_base_list[39]},	2,       	(u8*)&test.vars.arr_s64,        	"arr_s64",      	"None",                         	VAR_TYPE_S64,   	20,       	39, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[40],	(void*)&sofi_prop_base_list[40]},	2,       	(u8*)&test.vars.arr_float,      	"arr_float",    	"None",                         	VAR_TYPE_FLOAT, 	20,       	40, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[41],	(void*)&sofi_prop_base_list[41]},	2,       	(u8*)&test.vars.arr_double,     	"arr_double",   	"None",                         	VAR_TYPE_DOUBLE,	20,       	41, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[42],	(void*)&sofi_prop_base_list[42]},	2,       	(u8*)&test.vars.arr_char,       	"arr_char",     	"None",                         	VAR_TYPE_CHAR,  	20,       	42, 	0},
};
...
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[32]},	110},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[33]},	120},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[34]},	140},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[35]},	180},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[36]},	260},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[37]},	270},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[38]},	290},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[39]},	330},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[40]},	410},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[41]},	450},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[42]},	530},
};
