...
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[27],	(void*)&sofi_prop_base_list[28]},	2,       	(u8*)&device.vars.vref_int,      	"vref_int",      	"Vref internal (V)",            	VAR_TYPE_FLOAT, 	1,        	28, 	1},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[28],	(void*)&sofi_prop_base_list[29]},	2,       	(u8*)&device.vars.vref_ext,      	"vref_ext",      	"Vref external (V)",            	VAR_TYPE_FLOAT, 	1,        	29, 	1},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[31],	(void*)&sofi_prop_base_list[30]},	3,       	(u8*)&modbus.vars.addr,          	"addr",          	"Device ModBUS address",        	VAR_TYPE_U16,   	1,        	30, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[32],	(void*)&sofi_prop_base_list[31]},	2,       	(u8*)&service.vars.rtc_state,    	"rtc_state",     	"RTC service status",           	VAR_TYPE_U32,   	1,        	31, 	1},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[33],	(void*)&sofi_prop_base_list[32]},	2,       	(u8*)&service.vars.adc_int_state,	"adc_int_state", 	"ADC_INT service status",       	VAR_TYPE_U32,   	1,        	32, 	1},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[34],	(void*)&sofi_prop_base_list[33]},	2,       	(u8*)&service.vars.rs485_state,  	"rs485_state",   	"RS-485 service status",        	VAR_TYPE_U32,   	1,        	33, 	1},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[35],	(void*)&sofi_prop_base_list[34]},	2,       	(u8*)&service.vars.dbg_state,    	"dbg_state",     	"Debug service status",         	VAR_TYPE_U32,   	1,        	34, 	1},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[36],	(void*)&sofi_prop_base_list[35]},	2,       	(u8*)&service.vars.ai_state,     	"ai_state",      	"AI service status",            	VAR_TYPE_U32,   	1,        	35, 	1},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[40],	(void*)&sofi_prop_base_list[36]},	2,       	(u8*)&ai.vars.ai_value,          	"ai_value",      	"Measured value",               	VAR_TYPE_FLOAT, 	2,        	36, 	1},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[41],	(void*)&sofi_prop_base_list[37]},	3,       	(u8*)&ai.vars.ai_calib_a,        	"ai_calib_a",    	"Calibration coef A",           	VAR_TYPE_FLOAT, 	2,        	37, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[42],	(void*)&sofi_prop_base_list[38]},	3,       	(u8*)&ai.vars.ai_calib_b,        	"ai_calib_b",    	"Calibration coef B",           	VAR_TYPE_FLOAT, 	2,        	38, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[43],	(void*)&sofi_prop_base_list[39]},	2,       	(u8*)&ai.vars.ai_adc,            	"ai_adc",        	"ADC raw data",                 	VAR_TYPE_U16,   	2,        	39, 	1},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[44],	(void*)&sofi_prop_base_list[40]},	2,       	(u8*)&ai.vars.ai_sample_rate,    	"ai_sample_rate",	"Samples per second",           	VAR_TYPE_FLOAT, 	2,        	40, 	1},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[29],	(void*)&sofi_prop_base_list[41]},	2,       	(u8*)&test.vars.arr_u8,          	"arr_u8",        	"None",                         	VAR_TYPE_U8,    	20,       	41, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[37],	(void*)&sofi_prop_base_list[42]},	2,       	(u8*)&test.vars.arr_u16,         	"arr_u16",       	"None",                         	VAR_TYPE_U16,   	20,       	42, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[45],	(void*)&sofi_prop_base_list[43]},	2,       	(u8*)&test.vars.arr_u32,         	"arr_u32",       	"None",                         	VAR_TYPE_U32,   	20,       	43, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[46],	(void*)&sofi_prop_base_list[44]},	2,       	(u8*)&test.vars.arr_u64,         	"arr_u64",       	"None",                         	VAR_TYPE_U64,   	20,       	44, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[38],	(void*)&sofi_prop_base_list[45]},	2,       	(u8*)&test.vars.arr_s8,          	"arr_s8",        	"None",                         	VAR_TYPE_S8,    	20,       	45, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[47],	(void*)&sofi_prop_base_list[46]},	2,       	(u8*)&test.vars.arr_s16,         	"arr_s16",       	"None",                         	VAR_TYPE_S16,   	20,       	46, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[48],	(void*)&sofi_prop_base_list[47]},	2,       	(u8*)&test.vars.arr_s32,         	"arr_s32",       	"None",                         	VAR_TYPE_S32,   	20,       	47, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[49],	(void*)&sofi_prop_base_list[48]},	2,       	(u8*)&test.vars.arr_s64,         	"arr_s64",       	"None",                         	VAR_TYPE_S64,   	20,       	48, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[50],	(void*)&sofi_prop_base_list[49]},	2,       	(u8*)&test.vars.arr_float,       	"arr_float",     	"None",                         	VAR_TYPE_FLOAT, 	20,       	49, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[51],	(void*)&sofi_prop_base_list[50]},	2,       	(u8*)&test.vars.arr_double,      	"arr_double",    	"None",                         	VAR_TYPE_DOUBLE,	20,       	50, 	0},
{{SOFI_PROP_BASE,	(void*)&sofi_prop_mdb_list[39],	(void*)&sofi_prop_base_list[51]},	2,       	(u8*)&test.vars.arr_char,        	"arr_char",      	"None",                         	VAR_TYPE_CHAR,  	20,       	51, 	0},
};
...
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[28]},	106},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[29]},	108},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[41]},	110},
{{SOFI_PROP_MDB,	(void*)&sofi_prop_save_list[7],	(void*)&sofi_prop_base_list[24]},	120},
{{SOFI_PROP_MDB,	(void*)&sofi_prop_save_list[2],	(void*)&sofi_prop_base_list[30]},	140},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[31]},	141},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[32]},	143},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[33]},	145},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[34]},	147},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[35]},	149},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[42]},	151},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[45]},	171},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[51]},	181},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[36]},	200},
{{SOFI_PROP_MDB,	(void*)&sofi_prop_save_list[8],	(void*)&sofi_prop_base_list[37]},	204},
{{SOFI_PROP_MDB,	(void*)&sofi_prop_save_list[9],	(void*)&sofi_prop_base_list[38]},	208},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[39]},	212},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[40]},	214},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[43]},	218},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[44]},	258},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[46]},	338},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[47]},	358},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[48]},	398},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[49]},	478},
{{SOFI_PROP_MDB,	NULL,                          	(void*)&sofi_prop_base_list[50]},	518},
};
...
{{SOFI_PROP_SAVE,	NULL,       	(void*)&sofi_prop_base_list[30]},	4},
...
{{SOFI_PROP_SAVE,	NULL,       	(void*)&sofi_prop_base_list[37]},	98},
{{SOFI_PROP_SAVE,	NULL,       	(void*)&sofi_prop_base_list[38]},	106},
};
