...
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[14], 	(void*)&sand_prop_base_list[12]}, 	2,        	(u8*)&os.vars.build_date,           	"build_date",      	"Date of SW building",               	VAR_TYPE_CHAR,   	20,        	12,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[19], 	(void*)&sand_prop_base_list[13]}, 	2,        	(u8*)&device.vars.device_name,      	"device_name",     	"Device name",                       	VAR_TYPE_CHAR,   	40,        	13,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[21], 	(void*)&sand_prop_base_list[14]}, 	3,        	(u8*)&device.vars.user_note,        	"user_note",       	"User device name",                  	VAR_TYPE_CHAR,   	40,        	14,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[22], 	(void*)&sand_prop_base_list[15]}, 	3,        	(u8*)&device.vars.configuration,    	"configuration",   	"Hardware configuration",            	VAR_TYPE_CHAR,   	40,        	15,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[23], 	(void*)&sand_prop_base_list[16]}, 	2,        	(u8*)&device.vars.mcu_info,         	"mcu_info",        	"MCU information",                   	VAR_TYPE_CHAR,   	40,        	16,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[24], 	(void*)&sand_prop_base_list[17]}, 	2,        	(u8*)&device.vars.mcu_id,           	"mcu_id",          	"Unique MCU ID number",              	VAR_TYPE_U8,     	12,        	17,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[25], 	(void*)&sand_prop_base_list[18]}, 	2,        	(u8*)&device.vars.device_type,      	"device_type",     	"Device type code",                  	VAR_TYPE_U16,    	1,         	18,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[26], 	(void*)&sand_prop_base_list[19]}, 	3,        	(u8*)&device.vars.board_ver,        	"board_ver",       	"Hardware version",                  	VAR_TYPE_U16,    	1,         	19,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[27], 	(void*)&sand_prop_base_list[20]}, 	3,        	(u8*)&device.vars.serial,           	"serial",          	"Serial number",                     	VAR_TYPE_U32,    	1,         	20,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[28], 	(void*)&sand_prop_base_list[21]}, 	2,        	(u8*)&device.vars.temperature,      	"temperature",     	"Temperature (°C)",                  	VAR_TYPE_FLOAT,  	1,         	21,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[29], 	(void*)&sand_prop_base_list[22]}, 	2,        	(u8*)&device.vars.v_bat,            	"v_bat",           	"Battery voltage (V)",               	VAR_TYPE_FLOAT,  	1,         	22,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[30], 	(void*)&sand_prop_base_list[23]}, 	2,        	(u8*)&device.vars.v_pwr,            	"v_pwr",           	"Power voltage (V)",                 	VAR_TYPE_FLOAT,  	1,         	23,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[31], 	(void*)&sand_prop_base_list[24]}, 	2,        	(u8*)&device.vars.vref_int,         	"vref_int",        	"Vref internal (V)",                 	VAR_TYPE_FLOAT,  	1,         	24,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[32], 	(void*)&sand_prop_base_list[25]}, 	2,        	(u8*)&device.vars.vref_ext,         	"vref_ext",        	"Vref external (V)",                 	VAR_TYPE_FLOAT,  	1,         	25,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[33], 	(void*)&sand_prop_base_list[26]}, 	4,        	(u8*)&device.vars.tmpr_add,         	"tmpr_add",        	"Temperature add coeff",             	VAR_TYPE_FLOAT,  	1,         	26,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[34], 	(void*)&sand_prop_base_list[27]}, 	4,        	(u8*)&device.vars.v_pwr_mul,        	"v_pwr_mul",       	"Power voltage mul coeff",           	VAR_TYPE_FLOAT,  	1,         	27,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[35], 	(void*)&sand_prop_base_list[28]}, 	4,        	(u8*)&device.vars.v_pwr_add,        	"v_pwr_add",       	"Power voltage add coeff",           	VAR_TYPE_FLOAT,  	1,         	28,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[36], 	(void*)&sand_prop_base_list[29]}, 	4,        	(u8*)&device.vars.vref_sel,         	"vref_sel",        	"Select Vref source (0-Int, 1-Ext)", 	VAR_TYPE_U16,    	1,         	29,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[37], 	(void*)&sand_prop_base_list[30]}, 	2,        	(u8*)&service.vars.rtc_state,       	"rtc_state",       	"RTC service status",                	VAR_TYPE_U32,    	1,         	30,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[38], 	(void*)&sand_prop_base_list[31]}, 	2,        	(u8*)&service.vars.adc_int_state,   	"adc_int_state",   	"ADC_INT service status",            	VAR_TYPE_U32,    	1,         	31,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[39], 	(void*)&sand_prop_base_list[32]}, 	2,        	(u8*)&service.vars.rs485_state,     	"rs485_state",     	"RS-485 service status",             	VAR_TYPE_U32,    	1,         	32,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[40], 	(void*)&sand_prop_base_list[33]}, 	2,        	(u8*)&service.vars.dbg_state,       	"dbg_state",       	"Debug service status",              	VAR_TYPE_U32,    	1,         	33,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[41], 	(void*)&sand_prop_base_list[34]}, 	2,        	(u8*)&service.vars.ai_state,        	"ai_state",        	"AI service status",                 	VAR_TYPE_U32,    	1,         	34,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[43], 	(void*)&sand_prop_base_list[35]}, 	2,        	(u8*)&time.vars.year,               	"year",            	"Year",                              	VAR_TYPE_U16,    	1,         	35,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[44], 	(void*)&sand_prop_base_list[36]}, 	3,        	(u8*)&time.vars.month,              	"month",           	"Month [1..12]",                     	VAR_TYPE_U16,    	1,         	36,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[45], 	(void*)&sand_prop_base_list[37]}, 	3,        	(u8*)&time.vars.day,                	"day",             	"Day [1..31]",                       	VAR_TYPE_U16,    	1,         	37,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[46], 	(void*)&sand_prop_base_list[38]}, 	3,        	(u8*)&time.vars.hour,               	"hour",            	"Hour [0..23]",                      	VAR_TYPE_U16,    	1,         	38,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[47], 	(void*)&sand_prop_base_list[39]}, 	3,        	(u8*)&time.vars.minute,             	"minute",          	"Minute [0..59]",                    	VAR_TYPE_U16,    	1,         	39,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[48], 	(void*)&sand_prop_base_list[40]}, 	3,        	(u8*)&time.vars.sec,                	"sec",             	"Sec [0..59]",                       	VAR_TYPE_U16,    	1,         	40,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[49], 	(void*)&sand_prop_base_list[41]}, 	3,        	(u8*)&time.vars.msec,               	"msec",            	"Msec [0..999]",                     	VAR_TYPE_U16,    	1,         	41,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[50], 	(void*)&sand_prop_base_list[42]}, 	3,        	(u8*)&time.vars.utc,                	"utc",             	"Utc [-12..14]",                     	VAR_TYPE_S16,    	1,         	42,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[51], 	(void*)&sand_prop_base_list[43]}, 	2,        	(u8*)&time.vars.unix,               	"unix",            	"Unix timestamp",                    	VAR_TYPE_U32,    	1,         	43,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[53], 	(void*)&sand_prop_base_list[44]}, 	2,        	(u8*)&storage.vars.erase_cnt,       	"erase_cnt",       	"Storage FLASH erase counter",       	VAR_TYPE_U32,    	1,         	44,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[54], 	(void*)&sand_prop_base_list[45]}, 	4,        	(u8*)&storage.vars.autosave_en,     	"autosave_en",     	"Enable autosave",                   	VAR_TYPE_U16,    	1,         	45,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[55], 	(void*)&sand_prop_base_list[46]}, 	4,        	(u8*)&storage.vars.autosave_period, 	"autosave_period", 	"Autosave period (sec)",             	VAR_TYPE_U16,    	1,         	46,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[56], 	(void*)&sand_prop_base_list[47]}, 	2,        	(u8*)&storage.vars.last_save_time,  	"last_save_time",  	"Time of last save",                 	VAR_TYPE_U32,    	1,         	47,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[57], 	(void*)&sand_prop_base_list[48]}, 	2,        	(u8*)&storage.vars.dump_addr,       	"dump_addr",       	"Save dump FLASH address",           	VAR_TYPE_U32,    	1,         	48,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[58], 	(void*)&sand_prop_base_list[49]}, 	2,        	(u8*)&storage.vars.dump_position,   	"dump_position",   	"Save dump FLASH position",          	VAR_TYPE_U16,    	1,         	49,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[59], 	(void*)&sand_prop_base_list[50]}, 	2,        	(u8*)&storage.vars.dump_size,       	"dump_size",       	"Save dump size (bytes)",            	VAR_TYPE_U16,    	1,         	50,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[60], 	(void*)&sand_prop_base_list[51]}, 	2,        	(u8*)&storage.vars.storage_size,    	"storage_size",    	"Storage FLASH size (bytes)",        	VAR_TYPE_U16,    	1,         	51,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[61], 	(void*)&sand_prop_base_list[52]}, 	2,        	(u8*)&storage.vars.data_changed,    	"data_changed",    	"Data changed flag",                 	VAR_TYPE_U16,    	1,         	52,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[62], 	(void*)&sand_prop_base_list[53]}, 	2,        	(u8*)&storage.vars.duration_us,     	"duration_us",     	"Duration of save operation (us)",   	VAR_TYPE_U16,    	1,         	53,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[65], 	(void*)&sand_prop_base_list[54]}, 	4,        	(u8*)&modbus.vars.addr,             	"addr",            	"Device ModBUS address",             	VAR_TYPE_U16,    	1,         	54,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[66], 	(void*)&sand_prop_base_list[55]}, 	4,        	(u8*)&modbus.vars.addr_err_ingore,  	"addr_err_ingore", 	"Ignore ILLEGAL DATA ADDRESS error", 	VAR_TYPE_U16,    	1,         	55,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[67], 	(void*)&sand_prop_base_list[56]}, 	2,        	(u8*)&modbus.vars.rx_cnt,           	"rx_cnt",          	"Received packet counter",           	VAR_TYPE_U16,    	1,         	56,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[68], 	(void*)&sand_prop_base_list[57]}, 	2,        	(u8*)&modbus.vars.tx_cnt,           	"tx_cnt",          	"Transmitted packet counter",        	VAR_TYPE_U16,    	1,         	57,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[69], 	(void*)&sand_prop_base_list[58]}, 	2,        	(u8*)&modbus.vars.err_cnt,          	"err_cnt",         	"Error packet counter",              	VAR_TYPE_U16,    	1,         	58,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[70], 	(void*)&sand_prop_base_list[59]}, 	2,        	(u8*)&ai.vars.ai_value,             	"ai_value",        	"Measured value",                    	VAR_TYPE_FLOAT,  	2,         	59,  	1},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[71], 	(void*)&sand_prop_base_list[60]}, 	4,        	(u8*)&ai.vars.ai_calib_a,           	"ai_calib_a",      	"Calibration coef A",                	VAR_TYPE_FLOAT,  	2,         	60,  	0},
...
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[75], 	(void*)&sand_prop_base_list[64]}, 	4,        	(u8*)&ai.vars.avg_num,              	"avg_num",         	"None",                              	VAR_TYPE_U16,    	2,         	64,  	0},
...
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[12], 	(void*)&sand_prop_base_list[68]}, 	3,        	(u8*)&test.vars.arr_u8,             	"arr_u8",          	"U8 array",                          	VAR_TYPE_U8,     	20,        	68,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[15], 	(void*)&sand_prop_base_list[69]}, 	3,        	(u8*)&test.vars.arr_u16,            	"arr_u16",         	"U16 array",                         	VAR_TYPE_U16,    	20,        	69,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[16], 	(void*)&sand_prop_base_list[70]}, 	2,        	(u8*)&test.vars.arr_u32,            	"arr_u32",         	"U32 array",                         	VAR_TYPE_U32,    	20,        	70,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[42], 	(void*)&sand_prop_base_list[71]}, 	2,        	(u8*)&test.vars.arr_u64,            	"arr_u64",         	"U64 array",                         	VAR_TYPE_U64,    	20,        	71,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[13], 	(void*)&sand_prop_base_list[72]}, 	2,        	(u8*)&test.vars.arr_s8,             	"arr_s8",          	"S8 array",                          	VAR_TYPE_S8,     	20,        	72,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[17], 	(void*)&sand_prop_base_list[73]}, 	2,        	(u8*)&test.vars.arr_s16,            	"arr_s16",         	"S16 array",                         	VAR_TYPE_S16,    	20,        	73,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[18], 	(void*)&sand_prop_base_list[74]}, 	2,        	(u8*)&test.vars.arr_s32,            	"arr_s32",         	"S32 array",                         	VAR_TYPE_S32,    	20,        	74,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[52], 	(void*)&sand_prop_base_list[75]}, 	2,        	(u8*)&test.vars.arr_s64,            	"arr_s64",         	"S64 array",                         	VAR_TYPE_S64,    	20,        	75,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[63], 	(void*)&sand_prop_base_list[76]}, 	2,        	(u8*)&test.vars.arr_float,          	"arr_float",       	"FLOAT array",                       	VAR_TYPE_FLOAT,  	20,        	76,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[64], 	(void*)&sand_prop_base_list[77]}, 	2,        	(u8*)&test.vars.arr_double,         	"arr_double",      	"DOUBLE array",                      	VAR_TYPE_DOUBLE, 	20,        	77,  	0},
{{SAND_PROP_BASE, 	(void*)&sand_prop_mdb_list[20], 	(void*)&sand_prop_base_list[78]}, 	2,        	(u8*)&test.vars.arr_char,           	"arr_char",        	"CHAR array",                        	VAR_TYPE_CHAR,   	30,        	78,  	0},
};
...
{{SAND_PROP_MDB, 	(void*)&sand_prop_callback_list[1], 	(void*)&sand_prop_base_list[68]}, 	40},        // arr_u8
{{SAND_PROP_MDB, 	NULL,                               	(void*)&sand_prop_base_list[72]}, 	50},        // arr_s8
{{SAND_PROP_MDB, 	NULL,                               	(void*)&sand_prop_base_list[12]}, 	60},        // build_date
{{SAND_PROP_MDB, 	(void*)&sand_prop_callback_list[2], 	(void*)&sand_prop_base_list[69]}, 	70},        // arr_u16
{{SAND_PROP_MDB, 	NULL,                               	(void*)&sand_prop_base_list[70]}, 	90},        // arr_u32
{{SAND_PROP_MDB, 	NULL,                               	(void*)&sand_prop_base_list[73]}, 	130},       // arr_s16
{{SAND_PROP_MDB, 	NULL,                               	(void*)&sand_prop_base_list[74]}, 	150},       // arr_s32
{{SAND_PROP_MDB, 	NULL,                               	(void*)&sand_prop_base_list[13]}, 	200},       // device_name
{{SAND_PROP_MDB, 	NULL,                               	(void*)&sand_prop_base_list[78]}, 	220},       // arr_char
...
{{SAND_PROP_MDB, 	NULL,                               	(void*)&sand_prop_base_list[71]}, 	410},       // arr_u64
...
{{SAND_PROP_MDB, 	NULL,                               	(void*)&sand_prop_base_list[75]}, 	510},       // arr_s64
...
{{SAND_PROP_MDB, 	NULL,                               	(void*)&sand_prop_base_list[76]}, 	613},       // arr_float
{{SAND_PROP_MDB, 	NULL,                               	(void*)&sand_prop_base_list[77]}, 	653},       // arr_double
...
{{SAND_PROP_CALLBACK, 	NULL,        	(void*)&sand_prop_base_list[68]}, 	debug_err_led_on,  	1},         // arr_u8
{{SAND_PROP_CALLBACK, 	NULL,        	(void*)&sand_prop_base_list[69]}, 	debug_err_led_on,  	0},         // arr_u16
};
